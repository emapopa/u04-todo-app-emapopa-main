...
class Model
{
    ...
    public function del($del_id){
        $query = "DELETE FROM todo WHERE id = '$del_id' ";
        if ($sql = $this->conn->exec($query)) {
    ...
    public function read($read_id){
      ...
      $stmt = $this->conn->prepare("SELECT * FROM todo WHERE id='$read_id' ");
    ...
    public function edit($edit_id){
      ...
      $stmt = $this->conn->prepare("SELECT * FROM todo WHERE id='$edit_id'");
    ...
    public function update($data){
      $query = "UPDATE todo SET title = '$data[edit_title]', description = '$data[edit_description]', status = '$data[edit_status]'
